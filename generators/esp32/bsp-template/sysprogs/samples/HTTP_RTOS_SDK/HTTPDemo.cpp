...
void dhcps_lease_test(void)
{
	...
	IP4_ADDR(&dhcp_lease.start_ip, 192, 168, $$com.sysprogs.esp32.http.subnet$$, 100);
	IP4_ADDR(&dhcp_lease.end_ip, 192, 168, $$com.sysprogs.esp32.http.subnet$$, 105);
	wifi_softap_set_dhcps_lease(&dhcp_lease);
}

/*
	How to use this example:
		1. Build & program it to your ESP32
		2. Connect to the $$com.sysprogs.esp32.http.ssid$$ WiFi network from your computer
		3. Open http://192.168.$$com.sysprogs.esp32.http.subnet$$.1/test in your browser
*/
