...
namespace msp432_bsp_generator
{
    ...
    {                      
        static void Main(string[] args)
        {
            ...
            using (var bspBuilder = new Msp432Builder(new BSPDirectories(args[0], @"..\..\Output", @"..\..\rules", @"..\..\log")))
            {
                ...
                {
                    var rejectedMCUs = mcuFamilyBuilder.RemoveUnsupportedMCUs();
                    ...
                    if (!noPeripheralRegisters)
                    {
                        ...
                        //The register definition layout has changed in the latest SDK, so we currently use the last version that worked.
                        //Long-term, we should switch to parsing the SVD files instead.
                        var registersParser = new RegistersParser(@"..\..\rules\msp432p401r.h");
